...
1. Request Parameters
   ------------------
Name: Mulago_actual_coordinates_vi_2017_2019
Date Completed: 2019-04-29T10:42:10.093438
Id: 3a6bf7b2-70c6-4323-ba7f-b1e8b3ab1bc3
Details:
...
Mulago-actual-coordinates-vi-2017-2019-MOD13A3-006-results.csv
  Comma-separated values file with data extracted for a specific product

Mulago-actual-coordinates-vi-2017-2019-granule-list.txt
  Text file with data pool URLs for all source granules used in the extraction

Mulago-actual-coordinates-vi-2017-2019-request.json
  JSON request file which can be used in AppEEARS to create a new request

Mulago-actual-coordinates-vi-2017-2019-MOD13A3-006-metadata.xml
  xml file
