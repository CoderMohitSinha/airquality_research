...
1. Request Parameters
   ------------------
Name: jinja_road_nema_house_vi_2017_2019
Date Completed: 2019-04-29T13:19:33.761223
Id: f91a2509-2e20-44c7-8ef1-deba7083785f
Details:
  ...
  Coordinates:
      0.3141877, 32.5901072

Version:
    This request was processed by AppEEARS version 2.19


2. Request File Listing
   --------------------

jinja-road-nema-house-vi-2017-2019-MOD13A3-006-results.csv
  Comma-separated values file with data extracted for a specific product

jinja-road-nema-house-vi-2017-2019-granule-list.txt
  Text file with data pool URLs for all source granules used in the extraction

jinja-road-nema-house-vi-2017-2019-request.json
  JSON request file which can be used in AppEEARS to create a new request

jinja-road-nema-house-vi-2017-2019-MOD13A3-006-metadata.xml
  xml file
...
8. Data Product Citations
   ----------------------
 Didan, K. (2015). MOD13A3 MODIS/Terra vegetation Indices Monthly L3 Global 1km SIN Grid V006. NASA EOSDIS Land Processes DAAC. doi: 10.5067/MODIS/MOD13A3.006. Accessed April 29, 2019.
 

9. Software Citation
   -----------------
 AppEEARS Team. (2019). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.19. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed April 29, 2019. https://lpdaacsvc.cr.usgs.gov/appeears
